# Creation Log: anionzo:swarming

## Source Material

Origin:
- Existing `plugins/anionzo/skills/swarming/SKILL.md`
- Existing `plugins/anionzo/skills/executing/SKILL.md`
...
- Any onboarding rewrite for `.anionzo/onboarding.json`
...
Edits made:
- `plugins/anionzo/skills/swarming/SKILL.md`
...
- `plugins/anionzo/skills/executing/SKILL.md`
...
- `plugins/anionzo/skills/swarming/references/worker-template.md`
...
- `plugins/anionzo/skills/swarming/references/message-templates.md`
