---
name: xia
description: Research-first feature discovery for unfamiliar, ambiguous, or high-risk implementation work. Use when mapping the real repo stack, finding reusable local code, checking upstream patterns, and verifying current official docs before planning or implementing a feature.
metadata:
  dependencies:
    - id: exa
      kind: mcp_server
...
Use it to answer five questions **before building anything**:
