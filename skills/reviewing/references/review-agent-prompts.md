...
Exact prompts for the 5 specialist review agents dispatched in Phase 1 of the anionzo:reviewing skill.
...
- Do not flag pipeline artifacts (history/, .anionzo/) for deletion.
...
`.anionzo/findings/learnings-candidates.md`
...
Compounding candidates: N (see .anionzo/findings/learnings-candidates.md)
...
Do not flag pipeline artifacts (history/, .anionzo/, docs/) for deletion.
